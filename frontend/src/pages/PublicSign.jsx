    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        <div className="bg-white rounded-2xl shadow p-6">
          ...
          <p className="text-gray-500 mb-2">Document: <strong>{doc.originalName}</strong></p>
          <p className="text-gray-500 mb-6">Status: <span className="text-yellow-600 font-medium">{doc.status}</span></p>
